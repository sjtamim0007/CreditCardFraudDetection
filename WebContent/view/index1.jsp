    ...
    <div class="container">
      ...
      <div class="navigation collapse navbar-collapse navbar-ex1-collapse">
        <ul class="nav navbar-nav">
          ...
          <li><a href="registration.jsp" class="apply">Apply</a></li>
        </ul>
      </div>
    </div>
  </nav>
  ...
  <div id="intro">
    <div class="intro-text">
      <div class="container">
        <div class="col-md-12">
          <div id="rotator">
            <h1><span class="1strotate">ABC Bank, Start for U, Creativity and technology</span></h1>
            <div class="line-spacer"></div>
            <p><span class="2ndrotate">Trust, Identity, Security</span></p>
          </div>
        </div>
      </div>
    </div>
